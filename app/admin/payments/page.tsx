    ...
    <div className="min-h-screen">
      <main className="mx-auto max-w-[1500px] px-6 pb-24 pt-8">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <div className="text-[11px] font-medium uppercase tracking-[0.14em] text-white/40">Stripe</div>
            <h1 className="mt-1 text-2xl font-semibold tracking-tight">Collected payments</h1>
          </div>
        </div>
        {!configured && (
